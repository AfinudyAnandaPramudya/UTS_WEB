        ...
        <div class="card-header text-center"><a href="<?php echo e(url('/')); ?>" class="h1"><b>Admin</b>LTE</a></div>
            <div class="card-body">
                ...
                <form action="<?php echo e(url('login')); ?>" method="POST" id="form-login">
                    ...
                    <br>
                    <p>Don't have an account? <a href="<?php echo e(url('signup')); ?>">Register</a></p>
                </form>
            </div>
            <!-- /.card-body -->
        </div>
...
</html><?php /**PATH /Users/soncahyo/Workspace/projects/khen-joki/PWL_POS/resources/views/auth/login.blade.php ENDPATH**/ ?>