    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo e(url('/')); ?>" class="brand-link">
                <?php if(session()->has('profile_img_path')): ?>
                    <img src="<?php echo e(asset('storage/' . session('profile_img_path'))); ?>" alt="Profile Picture"
...
</html><?php /**PATH /Users/soncahyo/Workspace/projects/khen-joki/PWL_POS/resources/views/layouts/template.blade.php ENDPATH**/ ?>