    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <button onclick="modalAction('<?php echo e(url('supplier/create_ajax')); ?>')" class="btn btn-sm btn-success mt-1">Tambah
                    Ajax</button>
            </div>
        </div>
        <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            dataSupplier = $('#table_supplier').DataTable({
                ...
                ajax: {
                    "url": "<?php echo e(url('supplier/list')); ?>", // Endpoint untuk mengambil data supplier
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/soncahyo/Workspace/projects/khen-joki/PWL_POS/resources/views/supplier/index.blade.php ENDPATH**/ ?>