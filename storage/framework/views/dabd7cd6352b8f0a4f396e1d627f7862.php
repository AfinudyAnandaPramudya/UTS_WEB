...
<?php else: ?>
    <form action="<?php echo e(url('/user/' . $user->user_id . '/update_ajax')); ?>" method="POST" id="form-edit" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="level_id" id="level_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e($l->level_id == $user->level_id ? 'selected' : ''); ?> value="<?php echo e($l->level_id); ?>">
                                    <?php echo e($l->level_nama); ?></option>
...
<?php endif; ?>
<?php /**PATH /Users/soncahyo/Workspace/projects/khen-joki/PWL_POS/resources/views/user/edit_ajax.blade.php ENDPATH**/ ?>