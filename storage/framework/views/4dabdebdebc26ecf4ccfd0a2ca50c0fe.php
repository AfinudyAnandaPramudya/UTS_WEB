<div class="sidebar">
  ...
  <nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item">
        <a href="<?php echo e(url('/penjualan')); ?>" class="nav-link <?php echo e(($activeMenu == 'penjualan')? 'active' : ''); ?> ">
...
<?php /**PATH /Users/soncahyo/Workspace/projects/khen-joki/PWL_POS/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>